            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="myNavbar1">
                    <ul class="nav navbar-nav navbar-right navbar-search-link">
                        ...
                        <li class="dropdown active"><a href="#" class="dropdown-toggle" data-toggle="dropdown">User<span><i class="fa fa-angle-down"></i></span></a>
                        	...
                        	<div class="flex-content" >
                                <div class="custom-form custom-form-fields" style="background-color:#fff0cc" >
                                    ...
                                    <div class="other-links">
                                    	<p class="link-line">Tạo tài khoản mới ? <a href="#">Đăng ký</a></p>
